...
const Login = () => {
  ...
  return (
    <>
      <Navbar />
      <WithSubnavigation />
      <Grid h="88vh" templateColumns={"repeat(2,1fr)"}>
        <GridItem
          bgGradient="linear(to-b,white,#FFF9E1,#FFF4C4)"
          h="full"
          position={"relative"}
        >
          <Text
        ...
        <GridItem>
          <Text fontSize={"2xl"} mt="2%" fontWeight="500">
            Log In/Sign Up
          </Text>
          <Text fontSize={"xl"} mt="5%" color="gray">
          ...
          <Text color="black" fontSize={"xl"} mt="4%" mb="4%">
            OR
          </Text>
          <Flex
